...
import 'package:digital_local_library/widgets/message_handler.dart';
...
const List<Destination> allDestinations = <Destination>[
  Destination(
      title: 'All books', icon: Icons.library_books, color: Colors.teal),
  Destination(
      title: 'Saved books', icon: Icons.favorite, color: Colors.lightGreen),
